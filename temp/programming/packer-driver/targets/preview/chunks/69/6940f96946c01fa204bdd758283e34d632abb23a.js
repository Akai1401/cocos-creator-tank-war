      ...
      _export("Store", Store = (_dec = ccclass("Store"), _dec2 = property({
        ...
        handleBuyItem(itemId) {
          return _asyncToGenerator(function* () {
            var res = yield (_crd && buyItem === void 0 ? (_reportPossibleCrUseOfbuyItem({
              error: Error()
        ...
        onLoad() {
          (_crd && getAllItems === void 0 ? (_reportPossibleCrUseOfgetAllItems({
            ...
            if (this.itemPrefab) {
              res.forEach(item => {
                ...
                var userNode = instantiate(this.itemPrefab);
                var starPriceNode = userNode.getChildByName("star-price");
                ...
                var strkPriceNode = userNode.getChildByName("strk-price");
                ...
                var userCount = (this == null || (_this$itemListContain = this.itemListContainer) == null || (_this$itemListContain = _this$itemListContain.children) == null ? void 0 : _this$itemListContain.length) || 0;
                var row = Math.floor(userCount / 2);
                var col = userCount % 2;
                var xOffset = 300;
                var yOffset = 200;
                var newPosition = new Vec3(-150 + col * xOffset, 150 + -row * yOffset, 0);
          ...
          (_crd && getMyItem === void 0 ? (_reportPossibleCrUseOfgetMyItem({
            ...
            if (this.activeItemPrefab) {
              var userNode = instantiate(this.activeItemPrefab);
